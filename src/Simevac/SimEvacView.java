...
import Simulación.PanelSimulación;
 ...
 */
public class SimEvacView extends FrameView {

    public static final int INITIAL_HEIGHT = 500;
    public static final int INITIAL_WIDTH = 500;
//    private PanelSimulación simulación;

    public SimEvacView(SingleFrameApplication app) {
        super(app);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(Simevac.SimEvacApp.class).getContext().getResourceMap(SimEvacView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(Simevac.SimEvacApp.class).getContext().getActionMap(SimEvacView.class, this);
        ...
        uxPausa.addItemListener(new java.awt.event.ItemListener() {
    ...
    private void uxPausaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_uxPausaItemStateChanged
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            panelSimulación1.setPausado(true);
            uxMensajes.setText("Pausado...");
            uxPausa.setText("Continuar");
        } else {
            panelSimulación1.setPausado(false);
            uxMensajes.setText("Corriendo...");
            uxPausa.setText("Pausa");
        }
    }//GEN-LAST:event_uxPausaItemStateChanged
...
//            log.append("Open command cancelled by user." + newline);
    ...
    private Simulación.PanelSimulación panelSimulación1;
    private javax.swing.JProgressBar progressBar;
    private javax.swing.JLabel statusAnimationLabel;
    private javax.swing.JLabel statusMessageLabel;
    private javax.swing.JPanel statusPanel;
    private javax.swing.JLabel uxMensajes;
    private javax.swing.JToggleButton uxPausa;
